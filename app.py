...
# Gas selection including 'Universal'
gas_type = st.selectbox("Select Gas", ["CO2", "O2", "N2", "CH4", "H2", "Universal"])

# Dynamic feature labels
if gas_type == "Universal":
    feature_labels = [
        'PLD (Å)', 'LCD (Å)', 'Accessible Surface Area (m2/g)', 'Porosity', 'Pore Volume (cm3/g)',
        'σ (Å)', 'M.W. (g/mol)', 'Qst (kJ/mol)', 'Uptake 1 bar (mol/kg)', 'log(D₀) (cm²/s)'
    ]
elif gas_type in ["CH4", "H2"]:
    feature_labels = [
        'PLD (Å)', 'LCD (Å)', 'Accessible Surface Area (m2/g)', 'Porosity',
