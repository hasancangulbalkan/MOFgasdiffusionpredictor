...
tpot_data = pd.read_excel('CH4_CoRE_only_model.xlsx', dtype=np.float64)
...
# Average CV score on the training set was: -0.018536879242354483
exported_pipeline = make_pipeline(
    PolynomialFeatures(degree=2, include_bias=False, interaction_only=False),
    StackingEstimator(estimator=ElasticNetCV(l1_ratio=0.65, tol=0.0001)),
    ExtraTreesRegressor(bootstrap=False, max_features=0.9500000000000001, min_samples_leaf=2, min_samples_split=5, n_estimators=100)
)
