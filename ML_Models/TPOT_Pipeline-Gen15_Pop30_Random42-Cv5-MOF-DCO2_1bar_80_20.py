...
tpot_data = pd.read_excel('D:/coremof/results/ML/MD/V4/github/Original Label Sheets/Not Extended/CO2_CoRE_only_model.xlsx', dtype=np.float64)
...
# Average CV score on the training set was: -0.033039147232291344
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=RidgeCV()),
    RandomForestRegressor(bootstrap=False, max_features=0.35000000000000003, min_samples_leaf=2, min_samples_split=5, n_estimators=100)
)
