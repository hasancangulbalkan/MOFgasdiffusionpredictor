...
# NOTE: Make sure that the outcome column is labeled 'target' in the data file
tpot_data = pd.read_excel('O2_CoRE_only_model.xlsx', dtype=np.float64)
...
# Average CV score on the training set was: -0.005901573375445642
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=RidgeCV()),
    RandomForestRegressor(bootstrap=True, max_features=0.55, min_samples_leaf=2, min_samples_split=8, n_estimators=100)
)
