...
# NOTE: Make sure that the outcome column is labeled 'target' in the data file
tpot_data = pd.read_excel('N2_extended_model.xlsx', dtype=np.float64)
...
# Average CV score on the training set was: -0.005640942261101629
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    MinMaxScaler(),
    StackingEstimator(estimator=RidgeCV()),
    RandomForestRegressor(bootstrap=True, max_features=0.5, min_samples_leaf=4, min_samples_split=2, n_estimators=100)
)
