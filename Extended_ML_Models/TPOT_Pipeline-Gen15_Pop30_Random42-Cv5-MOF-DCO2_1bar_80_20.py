...
tpot_data = pd.read_excel('CO2_extended_model.xlsx', dtype=np.float64)
...
# Average CV score on the training set was: -0.029529787401538297
exported_pipeline = XGBRegressor(learning_rate=0.1, max_depth=7, min_child_weight=2, n_estimators=100, n_jobs=1, objective="reg:squarederror", subsample=0.9500000000000001, verbosity=0)
